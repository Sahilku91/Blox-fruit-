      ...
      while task.wait() do
        pcall(function()
          if _G.TeleportIsland or _G.AutoEvoRace or AutoFarmChest or _G.chestsea2 or _G.chestsea3 or _G.CastleRaid or _G.CollectAzure or _G.TweenToKitsune or _G.AutoCandy or _G.GhostShip or _G.Ship or _G.SailBoat or _G.Auto_Holy_Torch or _G.FindMirageIsland or _G.TeleportPly or _G.Tweenfruit or _G.AutoFishCrew or _G.AutoShark or _G.AutoCakeV2 or _G.AutoMysticIsland or _G.AutoQuestRace or _G.AutoBuyBoat or _G.dao or _G.AutoMirage or AutoFarmAcient or _G.AutoQuestRace or Auto_Law or _G.AutoAllBoss or AutoTushita or _G.AutoHolyTorch or _G.AutoTerrorshark or _G.farmpiranya or _G.DriveMytic or _G.AutoCakeV2V2 or PirateShip or _G.AutoSeaBeast or _G.AutoNear or _G.BossRaid or _G.GrabChest or AutoCitizen or _G.Ectoplasm or AutoEvoRace or AutoBartilo or AutoFactory or BringChestz or BringFruitz or _G.AutoLevel or _G.Clip2 or AutoFarmNoQuest or _G.AutoBone or AutoFarmSelectMonsterQuest or AutoFarmSelectMonsterNoQuest or _G.AutoBoss or AutoFarmBossQuest or AutoFarmMasGun or AutoFarmMasDevilFruit or AutoFarmSelectArea or AutoSecondSea or AutoThirdSea or AutoDeathStep or AutoSuperhuman or AutoSharkman or AutoElectricClaw or AutoDragonTalon or AutoGodhuman or AutoRengoku or AutoBuddySword or AutoPole or AutoHallowSycthe or AutoCavander or AutoTushita or AutoDarkDagger or _G.CakePrince or _G.AutoElite or AutoRainbowHaki or AutoSaber or AutoFarmKen or AutoKenHop or AutoKenV2 or _G.AutoKillPlayerMelee or _G.AutoKillPlayerGun or _G.AutoKillPlayerFruit or AutoDungeon or AutoNextIsland or AutoAdvanceDungeon or Musketeer or RipIndra or Auto_Serpent_Bow or AutoTorch or AutoSoulGuitar or Auto_Cursed_Dual_Katana or _G.AutoMaterial or Auto_Quest_Yama_1 or Auto_Quest_Yama_2 or Auto_Quest_Yama_3 or Auto_Quest_Tushita_1 or Auto_Quest_Tushita_2 or Auto_Quest_Tushita_3 or _G.Factory or _G.SwanGlasses or AutoBartilo or AutoEvoRace or _G.Ectoplasm then
            if not game:GetService("Players").LocalPl0ayer.Character.HumanoidRootPart:FindFirstChild("BodyClip") then
...
ImageButton.Image = "rbxassetid://16274437679"
...
local ToggleChest = Tabs.Main:AddToggle("ToggleChest", {
    Title = "Chest farm Stops when item comes ",
    Description = "", 
    Default = false })
...
if Second_Sea then
local ToggleChest = Tabs.Main:AddToggle("ToggleChest", {
    Title = "Picking up Chests stops when there are Items",
    Description = "", 
    Default = false })
ToggleChest:OnChanged(function(Value)
    _G.chestsea2 = Value
...
local Mastery = Tabs.Main:AddSection("Mastery Farm")
    ...
    local SliderHealt = Tabs.Main:AddSlider("SliderHealt", {
        Title = "Percentage of Monster Blood",
        Description = "",
        Default = 25,
        Min = 0,
        Max = 100,
...
local boss = Tabs.Main:AddSection("Farm Boss")
  ...
  local ToggleAutoFarmBoss = Tabs.Main:AddToggle("ToggleAutoFarmBoss", {
    ...
    local Material = Tabs.Main:AddSection("Farm materials")
    ...
    spawn(function()
      ...
      local ToggleTPKitsune = Tabs.Main:AddToggle("ToggleTPKitsune", {Title = "Tp kitsune island",Description = "", Default = false })
      ...
      local ToggleCollectAzure = Tabs.Main:AddToggle("ToggleCollectAzure", {Title = "Collect azure",Description = "", Default = false })
...
if Third_Sea then
    ...
    local ToggleSailBoat = Tabs.Main:AddToggle("ToggleSailBoat", {Title = "Sail ",Description = "", Default = false })
    ...
    local ToggleTerrorshark = Tabs.Main:AddToggle("ToggleTerrorshark", {Title = " Farm Terrorshark",Description = "", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Main:AddToggle("TogglePiranha", {Title = "Farm piranaha",Description = "", Default = false })
    ...
    local ToggleFishCrew = Tabs.Main:AddToggle("ToggleFishCrew", {Title = " Farm Fish Crew",Description = "", Default = false })
    ...
    local ToggleShip = Tabs.Main:AddToggle("ToggleShip", {Title = "Ship select",Description = "", Default = false })
...
while wait() do
    ...
    local ToggleGhostShip = Tabs.Main:AddToggle("ToggleGhostShip", {Title = "Get ghost boat",Description = "",Default = false })
...
spawn(function()
    ...
    local AutoElite = Tabs.Main:AddSection("Farm Boss elite")

    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Farm boss",Description = "", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Sail boat For Sea Beast for ma ",Description = "", Default = false })
...
ToggleAutoW:OnChanged(function(Value)
 ...
 spawn(function()
    ...
    local AutoMysticIsland = Tabs.Main:AddSection("Mysterious Island")


    Tabs.Main:AddButton({
        Title = "Fly To Mysterious Island",
        Description = "",
        Callback = function()
            TweenMirage()
        end
    ...
    Tabs.Main:AddButton({
        Title = "Fly to the Highest Place",
        Description = "",
        Callback = function()
            TwenetoHighestPoint()
        end
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Main:AddToggle("Togglelockmoon", {Title = "Look at the Moon + Turn on the Tribe",Description = "", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Find mirage",Description = "", Default = false })
...
if Third_Sea then
  ...
  spawn(function()
           ...
           local ToggleYama = Tabs.Main:AddToggle("ToggleYama", {Title = "Get Yama",Description = "", Default = false })
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Get tushita",Description = "", Default = false })
        ...
        Options.ToggleTushita:SetValue(false)
           spawn(function()
                   ...
                   local ToggleHoly = Tabs.Main:AddToggle("ToggleHoly", {Title = " Tushita",Description = "", Default = false })
...
if Second_Sea then
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Factory farm",Description = "", Default = false })
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "kill Katakuri V2 needed",Description = "", Default = false })
...
if Second_Sea or Third_Sea then
    local ToggleHakiColor = Tabs.Main:AddToggle("ToggleHakiColor", {Title = "Buy haki colours",Description = "",Default = false })
...
if Second_Sea then
    local ToggleEvoRace = Tabs.Main:AddToggle("ToggleEvoRace", {Title = "Get V2",Description = "",Default = false })
...
local ToggleDe = Tabs.Stats:AddToggle("ToggleDe", {Title = "De",Description = "", Default = false })
...
local ToggleSword = Tabs.Stats:AddToggle("ToggleSword", {Title = "Choose sword",Description = "", Default = false })
...
local ToggleGun = Tabs.Stats:AddToggle("ToggleGun", {Title = "Select gun", Description = "",Default = false })
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title = "Select fruit",Description = "", Default = false })
...
local ToggleQuanSat = Tabs.Player:AddToggle("ToggleQuanSat", {Title = "Observe the Player",Description = "", Default = false })
...
local ToggleShowFov = Tabs.Player:AddToggle("ToggleShowFov", {Title = "High Fov",Description = "", Default = false })
...
local ToggleAimBotSkill = Tabs.Player:AddToggle("ToggleAimBotSkill", {Title = "Automatically view Skills",Description = "", Default = false })
...
local Teleport = Tabs.Teleport:AddSection("Transform the world")
...
local Mastery = Tabs.Teleport:AddSection("Choose island")
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title = "Random ",Description = "", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Tp to devil fruit ",Description = "", Default = false })
...
spawn(function()
    ...
    local ToggleStart = Tabs.Raid:AddToggle("ToggleStart", {Title = "Enter Raid",Description = "", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Get Fruit with Beli",Description = "", Default = false })
...
local ToggleLaw = Tabs.Raid:AddToggle("ToggleLaw", {Title = "Defet boss law",Description = "", Default = false })
...
local ToggleHumanandghoul = Tabs.Race:AddToggle("ToggleHumanandghoul", {Title = "Complete Demon + Human Clan",Description = "", Default = false })
...
local Mastery = Tabs.Race:AddSection("MASTRY")

local ToggleAutoAcientQuest = Tabs.Race:AddToggle("ToggleAutoAcientQuest", {Title = "Plow + Turn On Tribe",Description = "", Default = false })
...
local ToggleRandomBone = Tabs.Shop:AddToggle("ToggleRandomBone", {Title = "Random suprise",Description = "", Default = false })
...
local Mastery = Tabs.Shop:AddSection("Mastry")
...
Tabs.Misc:AddButton({
  Title = "Open the awakening skill table",
  Description = "",
  Callback = function()
  ...
  Callback = function()
    ...
    for k, v in pairs(cac) do
      if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
        ...
        huhu.Image = "http://www.roblox.com/asset/?id=16274437679"
...
if First_Sea or Second_Sea then
    local Mastery = Tabs.Hop:AddSection("Sea 3!!!")
end

if Third_Sea then
local ToggleFindMoon = Tabs.Hop:AddToggle("ToggleFindMoon", {Title = "Check moon",Description = "", Default = false })
...
local ToggleMirageIsland = Tabs.Hop:AddToggle("ToggleMirageIsland", {Title = "Fimd mirage",Description = "", Default = false })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Toggle remove",Description = "", Default = true })
...
local ToggleRemoveNotify = Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = "Delete All",Description = "", Default = false })
ToggleRemoveNotify:OnChanged(function(Value)
    ...
    local ToggleWhite = Tabs.Setting:AddToggle("ToggleWhite", {Title = " White screen (less lag)",Description = "", Default = false })
...
local ToggleZ = Tabs.Setting:AddToggle("ToggleZ", {Title = "TOGGLE Z",Description = "", Default = true })
ToggleZ:OnChanged(function(Value)
    SkillZ = Value
end)
Options.ToggleZ:SetValue(true)

local ToggleX = Tabs.Setting:AddToggle("ToggleX", {Title = "TOGGLE X", Description = "",Default = true })
...
local ToggleC = Tabs.Setting:AddToggle("ToggleC", {Title = "TOGGLE C",Description = "", Default = true })
